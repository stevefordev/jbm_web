...
<div id="contentsBox">
	<div id="infoBox">
		<dl>
			...
			<dd>
				<time id="regdate"><%=board.getRegdate() %></time>
			</dd>
			<dt class="screen_out">조회수</dt>
			<dd id="hit">
				<i class="fa fa-eye"></i> <%=board.getHit() %>
			</dd>
		</dl>
		<h3 id="title"><%=board.getTitle() %></h3>
	</div>
	<p id="contents"><%=board.getContents() %></p>
	...
	<div class="box_btn">
			...
			<%=board.getLikes() %></strong>
			</button>
		<div id="boxBtn">
		<% if(loginMember !=null  && board.getWriterNo()==loginMember.getNo()) { %>
			<a href="/updateForm.jsp" class="btn" id="modifyBtn">수 정</a>
			<a href="/delete.jsp" class="btn" id="deleteBtn">삭 제</a>
		<%} %>
