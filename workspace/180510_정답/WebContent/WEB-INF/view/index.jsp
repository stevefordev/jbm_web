...
<body>
    <div id="loginBox">
        <h1><img width="50"  src="img/logo.png"/> <span>영화 매니아 천국</span></h1>
        <div id="infoBox">
            <form action="/session" method="post">
                <fieldset>
                    ...
                    <button id="loginBtn" title="로그인버튼"><i class="fas fa-map-signs"></i> 로그인</button>
                </fieldset>
            </form>
            <a id="joinLink" href="/mania/join"><i class="fab fa-pinterest"></i> 회원가입</a>
        </div><!--//infoBox -->
    </div><!--//#loginBox -->
  <c:if test="${msg!=null}">
<script>
