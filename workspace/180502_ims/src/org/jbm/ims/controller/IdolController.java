...
public class IdolController {
	...
	@RequestMapping(
			value="/updateIdol.ims",
			method=RequestMethod.GET)
	public String xxxsdfadfa(
			Model model,int no) {
	...
	@RequestMapping(value="/insertIdol.ims",
			         method=RequestMethod.GET)
	 ...
	 * 만약 넘어온 파라미터와
	 * 멤버필드의 자료형이 맞지 않은 
	 * 경우 400 bad request 에러가
	 * 떨어지게 됩니다.
	 * 
	 * VO와 파라미터 맵핑이 어디가
	 * 잘못되었는지 확인하고 싶으면 
	 * BindingResult객체를 받아서 
	 * 확인할 수 있습니다.
	 * (400 에러 발생안함)
	 * 
	 */
...
//		}
	...
	@RequestMapping(value="/deleteIdol.ims",
			method=RequestMethod.GET)
	...
	public void idolList(Model model) {
		...
		model.addAttribute("xxx", idolsService.getIdols());
	}
